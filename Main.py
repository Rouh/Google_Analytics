# Check out the competiotion rules in this link: https://www.kaggle.com/c/ga-customer-revenue-prediction/rules
...
train_file = "DATASET: https://www.kaggle.com/c/ga-customer-revenue-prediction/"
test_file = "DATASET: https://www.kaggle.com/c/ga-customer-revenue-prediction/"
...
X_all, y_all = train[train.columns[train.columns != 'target']],train['target']
...
yhat_1 = predict(X_all,y_all,X_test)
yhat_1[yhat_1 < 0] = 0
yhat_2 = predict(X_ret,y_ret,X_test)
yhat_2[yhat_2 < 0] = 0
...
sub_df["PredictedLogRevenue"] = yhat_all
